  ...
  return (
    <div className="mb-10 w-full max-w-[1200px] mx-auto rounded-[20px] border border-[#EDEDED] bg-[#F5F5F5] p-6 lg:p-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_545px] lg:gap-x-8">
        ...
        {/* Key Highlights heading (desktop above list; mobile above image) */}
    ...
    <div className="w-full min-h-screen bg-white font-loew">
      ...
      <div className="container mx-auto px-4 lg:px-6 py-[100px]">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-3">
                ...
                <p className="text-brand-gray text-[16px] font-medium leading-[24px]">
                  ...
                  investment relations, operate air cargo facilities, and
                  enhance operational capabilities and efficiency of airports to
                  keep up with the evolution of the aviation industry.
                </p>
              </div>
            </div>
        ...
        <div className="mb-[100px]">
                  ...
                  <div className="w-[155px] flex flex-col items-center gap-3">
                    ...
                    <div
                      className={cn(
                        ...
                        item.active ? "bg-[#F5F0FF] border-[#EDEDED]" : "bg-white border-[#EDEDED]"
                      )}
                    >
                    ...
                    <div
                      className={cn(
                        ...
                        item.active ? "bg-brand-purple border-brand-purple" : "bg-white border-[#EDEDED]"
                      )}
                    />
                  </div>
                </SwiperSlide>
          ...
          {/* Active detail card - Shared (responsive for mobile + desktop) */}
        ...
        <div className="mb-[100px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-[30px] lg:grid-rows-2">
            {values.map((value, index) => (
              ...
              >
                <div className="flex-shrink-0 w-[110px] h-[110px] rounded-[14px] border border-[#EDEDED]  flex items-center justify-center p-[5px_15px]">
