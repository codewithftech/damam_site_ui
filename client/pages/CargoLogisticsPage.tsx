  ...
  return (
    <div className="w-full min-h-screen bg-white font-loew">
      ...
      <div className="container mx-auto  py-12 lg:py-[108px]">
        ...
        {/* Stats Banner */}
        <div className="relative rounded-[20px] overflow-hidden mb-12 lg:mb-[72px]  h-[250px] lg:h-[311px]">
          <img
        ...
        {/* Circular Section */}
        <div className="rounded-[20px] border border-[#EDEDED] bg-[#F5F5F5] p-6 lg:p-[30px]  mb-12 lg:mb-[72px]">
