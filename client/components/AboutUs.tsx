...
export default function AboutUs() {
  ...
  return (
    ...
    <section id="about" className="bg-white overflow-hidden">
      <div className="container mx-auto py-[100px] lg:pt-[108px] lg:pb-[108px]">
        {/* Heading */}
        <h2 className="text-[36px] lg:text-[48px] font-medium leading-[46px] lg:leading-[60px] tracking-[-0.72px] lg:tracking-[-0.96px] mb-4 lg:mb-[72px]  lg:text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-x-[30px] lg:gap-y-[30px]">
          {cards.map((card, index) => (
            <div
              key={index}
              className="rounded-[16px] lg:rounded-[20px] border border-[#EDEDED] bg-[#F5F5F5] overflow-hidden flex flex-col h-full"
            >
              {/* Image */}
              <div className="w-full aspect-[343/244] lg:aspect-[585/248] overflow-hidden flex-shrink-0">
                <img
                  src={card.image}
                  alt={card.title}
