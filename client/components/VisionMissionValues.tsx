    ...
    <div className="mb-[100px]">
      ...
      <div className="hidden lg:block mb-[100px]">
        <div className="w-full max-w-[1200px] mx-auto">
          {/* Image container (stable even if image changes) */}
          <div className="relative w-full overflow-hidden aspect-[926/615] rounded-tr-[20px] rounded-br-[20px] rounded-tl-[20px] rounded-bl-0">
            <img
            ...
            {/* Soft tint to keep design consistent across images */}
            ...
            {/* Mission Card (bottom corner) */}
            <div
              className={cn(
                "absolute bottom-0 w-[330px] min-h-[267px] rounded-tr-[20px]  bg-white pt-6 pr-6 shadow-sm flex items-center justify-center",
                isRTL ? "right-0" : "left-0"
              )}
            >
              <div
                className="w-[307px] min-h-[239px] rounded-[20px] border border-[#EDEDED] bg-[#F5F5F5] p-6 flex flex-col items-center text-center"
              >
                <svg
                  className="mb-[17px]"
                  width="39"
              ...
              {/* Vision Card (top corner) */}
              <div
                className={cn(
                  "absolute top-0 w-[330px] min-h-[267px] rounded-bl-[20px] bg-white pb-6 pl-6 shadow-sm flex items-center justify-center",
                  isRTL ? "left-0" : "right-0"
                )}
              >
                <div className="w-[307px] min-h-[239px] rounded-[20px] border border-[#EDEDED] bg-[#F5F5F5] p-6 flex flex-col items-center text-center">
                  <svg
                    className="mb-[17px]"
                    width="38"
                    height="46"
        ...
        <div className="lg:hidden flex flex-col gap-4 mb-6">
          ...
          {/* Vision Card */}
          <div className="rounded-[20px]  bg-[#F5F5F5] pt-6 flex flex-col items-center text-center min-h-[239px]">
            <svg
              className="mb-[17px]"
              width="38"
              height="46"
